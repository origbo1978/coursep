"""
Django settings for Course_correct project.
...
ROOT_URLCONF = 'Course_correct.urls'
...
WSGI_APPLICATION = 'Course_correct.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('SUPABASE_DB'),        # ← Matches .env
        'USER': os.getenv('SUPABASE_USER'),      # ← Matches .env
